...
namespace Webserver {
	public abstract class APIEndpoint {
		...
		/// </summary>
		public virtual void GET() => Utils.Send(Utils.GetErrorPage(HttpStatusCode.MethodNotAllowed), Context.Response, HttpStatusCode.MethodNotAllowed);
		...
		/// </summary>
		public virtual void HEAD() => Utils.Send(Utils.GetErrorPage(HttpStatusCode.MethodNotAllowed), Context.Response, HttpStatusCode.MethodNotAllowed);

		/// <summary>
		/// Called when a HTTP.POST request is sent to this endpoint.
		/// POST requests are used to submit new data to the server.
		/// </summary>
		public virtual void POST() => Utils.Send(Utils.GetErrorPage(HttpStatusCode.MethodNotAllowed), Context.Response, HttpStatusCode.MethodNotAllowed);

		/// <summary>
		/// Called when a HTTP.PUT request is sent to this endpoint.
		/// PUT requests are used to replace data on the server.
		/// </summary>
		public virtual void PUT() => Utils.Send(Utils.GetErrorPage(HttpStatusCode.MethodNotAllowed), Context.Response, HttpStatusCode.MethodNotAllowed);

		/// <summary>
		/// Called when a HTTP.DELETE request is sent to this endpoint.
		/// DELETE requests are used to delete data from the server.
		/// </summary>
		public virtual void DELETE() => Utils.Send(Utils.GetErrorPage(HttpStatusCode.MethodNotAllowed), Context.Response, HttpStatusCode.MethodNotAllowed);
		...
		/// </summary>
		public virtual void CONNECT() => Utils.Send(Utils.GetErrorPage(HttpStatusCode.MethodNotAllowed), Context.Response, HttpStatusCode.MethodNotAllowed);
		...
		/// </summary>
		public virtual void OPTIONS() => Utils.Send(Utils.GetErrorPage(HttpStatusCode.MethodNotAllowed), Context.Response, HttpStatusCode.MethodNotAllowed);
		...
		/// </summary>
		public virtual void TRACE() => Utils.Send(Utils.GetErrorPage(HttpStatusCode.MethodNotAllowed), Context.Response, HttpStatusCode.MethodNotAllowed);

		/// <summary>
		/// Called when a HTTP.PATCH request is sent to this endpoint.
		/// A PATH request is used to partially modify data.
		/// </summary>
		public virtual void PATCH() => Utils.Send(Utils.GetErrorPage(HttpStatusCode.MethodNotAllowed), Context.Response, HttpStatusCode.MethodNotAllowed);
